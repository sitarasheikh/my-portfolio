    ...
    <div id="about" className='bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]'>
      <div className='grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center'>
        <div>
          ...
          <h2 className='text-[25px] font-bold lg:text-[45px] md:leading-[3rem] leading-[2rem] capitalize mb-[3rem] text-white'>
            Transforming <span className='text-yellow-400'>Visions</span>
          </h2>
          <div className='mb-[3rem] flex items-center md:space-x-10'>
            <span className='w-[100px] hidden md:block h-[5px] bg-slate-400 rounded-sm'></span>
            <p className='text-[19px] text-slate-300 w-[80%]'>
              I am a highly motivated and dedicated software engineer with a passion for transforming innovative ideas into reality. I have worked on various projects, including web development and AI integrations. I
            </p>
          </div>
